...
Порт для .Net Framework, версия для .Net [тут](https://github.com/SaaSoft/max-bot-api-client-dotnet)
...
```xml
<PackageReference Include="MAX.Bot.NetFramework" Version="1.0.3.0" />
```
